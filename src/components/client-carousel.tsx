        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {clients.map((client, index) => (
            <motion.div
              ...
              className="group"
            >
                             <div className="bg-background rounded-xl p-6 border hover:shadow-lg transition-all duration-300 hover:scale-105 text-center h-full flex flex-col justify-between">
                 <div>
                   {/* Logo placeholder - you can replace this with actual logos */}
                   <div className="w-16 h-16 bg-gradient-to-br from-accent-highlight/10 to-accent-highlight/20 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                     <Building2 className="w-8 h-8 text-accent-highlight" />
                   </div>
